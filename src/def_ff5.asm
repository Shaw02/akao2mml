...
;*								*
;****************************************************************
MML2MID_HED	DB	'#title     "FINAL FANTASY 5  "',0dh,0ah
		DB	'#copyright "植松 伸夫　　(c)SQUARE"',0dh,0ah
		db	0dh,0ah,24h
...
MUSIC_ADDRESS	EQU	1D02h	;ヘッダーの位置
MUSIC_DATA	EQU	1D14h	;データの位置
